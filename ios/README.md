...
iOS 0.1.0 (35) 已于 2026-09-15 确认进入 TestFlight 内部测试，详见 [build 35](../docs/RELEASE-0.1.0-35.md)。本次优化会话列表、聊天阅读与大字号排版。新增 OMP 接入与手机模型配置、本地 Markdown / 图片 / 视频预览、会话品牌图标。最新交互包括星光工具菜单、思考力度分档滑条、原生文本选区与复制、按住说话（上滑取消）及回复朗读。
