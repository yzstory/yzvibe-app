...
**本轮更新**：设备 Token 认证状态、诊断与配置页手动切换连接，以及按所属轮次定位的任务交付卡。iOS build 12 兼容已运行的 Connector 0.1.1，详见 [发布说明](docs/RELEASE-0.1.0-12.md)；可靠待发送箱、消息去重与中断恢复见 [build 11](docs/RELEASE-0.1.0-11.md)。
