...
运行 `python3 html/build.py`。产物为 `html/dist/yzvibe-site.tar.gz` 和对应 SHA256 文件。打包使用固定白名单，只包含页面、样式、脚本及五张图片；部署配置、文档、服务器 skill 与证书不进入公开文件。
...
- `assets/`：2026-09-15 从 iPhone 17 Pro / iOS 26.5 和 Android API 35 模拟器重新截取的真实 App 演示数据画面；Logo 来自 `docs/assets/yzvibe-logo.png`，缩至 256px。
...
安卓下载二维码来自用户提供图片，已解码核对为 https://www.pgyer.com/youzivibe 。
