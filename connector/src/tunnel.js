...
export function startCloudflareTunnel(port, { timeoutMs = 40_000, registerMs = 20_000, log = console.log } = {}) {
  return new Promise((resolve, reject) => {
    ...
    const tryNext = () => {
      ...
      let done = false, url = null, registerTimer = null;
